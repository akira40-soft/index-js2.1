...
class APIClient {
    ...
    */
    buildPayload(messageData) {
        const { usuario, numero, mensagem, tipo_conversa = 'pv', tipo_mensagem = 'texto', mensagem_citada = '', reply_metadata = {}, imagem_dados = null, grupo_id = null, grupo_nome = null, forcar_pesquisa = false } = messageData;
        const payload = {
