        ...
        try {
            ...
            switch (command) {
                ...
                case 'demote': {
                    ...
                    try {
                        if (this.securityLogger) {
                            const targetJids = this.groupManagement
                                ? this.groupManagement._extractTargets?.(m) || []
                                : [];
                ...
                case 'restart':
                    ...
                    return true;
                default:
                    if (isOwner && await this.osintFramework.handleCommand(m, command, args))
                        return true;
                    return false;
            }
        }
...
💡 Use *${P}menu [categoria]* para ver detalhes de cada comando.`;
    ...
    async _handleWelcome(m, command, args, fullArgs) {
        ...
        switch (subCommand) {
            ...
            case 'setwelcome':
                if (!fullArgs)
                    return await this._reply(m, '❌ Informe o texto de boas-vindas.');
            ...
            case 'setgoodbye':
                if (!fullArgs)
                    return await this._reply(m, '❌ Informe o texto de saída.');
