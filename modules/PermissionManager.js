...
class PermissionManager {
    constructor() {
        ...
        this.commandPermissions = {
            ...
            'tagall': { nivel: 'owner', requiresRegistration: true, rateLimitMultiplier: 1, grupo: true },
            'hidetag': { nivel: 'owner', requiresRegistration: true, rateLimitMultiplier: 1, grupo: true },
            'totag': { nivel: 'owner', requiresRegistration: true, rateLimitMultiplier: 1, grupo: true },
            'welcome': { nivel: 'owner', requiresRegistration: true, rateLimitMultiplier: 1, grupo: true },
